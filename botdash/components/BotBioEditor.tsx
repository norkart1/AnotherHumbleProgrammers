...
export default function BotBioEditor() {
    ...
    <div className="bg-[#2c2f33] rounded-xl border border-[#36393f] overflow-hidden">
      <div className="px-5 py-4 border-b border-[#36393f]">
        ...
        <p className="text-[#72767d] text-xs mt-0.5">
          Update the bio shown on the bot&apos;s Discord profile
        </p>
      </div>
        ...
        <div className="relative">
          ...
          <span
            className={`absolute bottom-3 right-3 text-[10px] font-mono ${
              overLimit ? 'text-[#ed4245]' : bio.length > maxLen * 0.8 ? 'text-[#faa61a]' : 'text-[#4f545c]'
            }`}
          >
            {bio.length}/{maxLen}
          </span>
