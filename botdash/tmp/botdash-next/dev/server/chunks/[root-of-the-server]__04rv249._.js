...
"[project]/app/api/announcement/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        const snap = await db.collection('announcements').where('guildId', 'in', session.guildIds.length > 0 ? session.guildIds : [
            '__none__'
...
async function POST(req) {
    ...
    try {
        ...
        if (!session.guildIds.includes(guildId)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Access denied to this server'
        }, {
            status: 403
        });
        if (!header?.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04rv249._.js.map