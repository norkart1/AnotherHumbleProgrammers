...
async function proxy(req) {
    ...
    const cookie = req.cookies.get(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$session$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["SESSION_COOKIE"])?.value;
    if (!cookie) {
    ...
    const session = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$session$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["decodeSession"])(cookie);
    if (!session) {
        const loginUrl = req.nextUrl.clone();
        loginUrl.pathname = '/login';
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(loginUrl);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0wg2w-3._.js.map