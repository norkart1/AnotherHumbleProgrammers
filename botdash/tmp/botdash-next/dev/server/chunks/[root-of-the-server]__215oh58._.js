...
"[project]/app/api/guilds/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        const guilds = snap.docs.filter((doc)=>session.guildIds.includes(doc.id)).map((doc)=>{
            const d = doc.data();
            return {
                id: d.id,
                name: d.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__215oh58._.js.map